...
<html>
  ...
  <body>
    ...
    <div>
      <div>
          <p style="float: left;clear: left"><img src="food1.PNG" width="200" height="150"></p>
      	<div>
      	<br><br><br>
          <a href="food1.php"><p>BANANA PEANUT BUTTER HANDMADE BISCUITS <br> rs.350</p></a>
      	</div>
       </div>
       <br><br><br> <br>
        ...
        <div style="clear: left">
          ...
          <a href="food2.php"><p style="float: left;clear: left"><img src="food2.PNG" width="200" height="150"></p>
          <div>
      	<br><br><br>
          <p>CARROT PEANUT BUTTER HANDMADE BISCUITS<br> Rs.450</p></a>
      	</div>
        </div>

        <br><br> <br><br>
         <p style="float: left;clear: left"><img src="food3.PNG" width='200' height="150"></p>
         <div>
      	<br><br><br>
          <p>CHICKEN & SWEET POTATO HANDMADE BISCUITS <br> <strong>OUT OF STOCK</strong></p>
      	</div>
        <br><br><br><br><br><br>
        <footer>
