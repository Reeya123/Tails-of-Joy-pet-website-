...
<html>
  ...
  <body>
    ...
    <img src="bed1.png" width="300" height="250" align="centre" />
    <h3>Rs.1499</h3>
    <p>
      Automatically Recharging Cooling Pad Provides Continuous Relief Up to 3
      Hours. Versatile Mat Design Soothes & Prevents Overheating & Dehydration
      in the Heat. Non-Toxic, Completely Latex-Free Material is 100% Safe for
      Animals, Adults & Kids. Flexible Mat Folds Flat; Retains its Shape Over
      Time; Wipes Clean for Years of Use. Highly Durable Solid Gel Construction
      is Convenient for Traveling & Quick Storage.
    </p>
    <br />
    <h2>Features</h2>
    <ol>
      <li>Super cool,non-allergic, waterproof, easy to clean and wash.</li>
      <li>Portable pet blanket, suitable for travel and outdoor activities</li>
      <li>Easy to carry, traveling with pets is essential!</li>
      <li>
        Multi-functional blanket, ideal for bring your pet to traveling or
        outdoors
      </li>
    </ol>
